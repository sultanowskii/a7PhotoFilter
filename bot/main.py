...
def help(update, context):
    ...
    update.message.reply_text(
        ...
        "своих друзей!\n\n"
        "❗️Важно\n"
        "   - <b>Отправляйте ваше фото только в главном меню!</b>"
        ...
        "👨‍💻 Разработчики: @sultanowskii, @gabidullin_kamil\n"
        "Github (sultanowskii): https://github.com/sultanowskii/a7PhotoFilter\n\n"
...
def show_room(update, context, num=None, refresh=True):  # Function to show user one current room, num is room's local
    ...
    name = room.get('name')
    text = f'🗃Комната \"{name}\" ({room["users_count"]}/{config.ROOM_USER_LIMIT} пользователей):\n'
